...
async function createOrder(user, shippAddress) {
  ...
  const createdOrder = new Order({
    ...
    orderDate: new Date(),
    orderStatus: "COMPLETED", // Assuming OrderStatus is a string enum or a valid string value
    "paymentDetails.status": "COMPLETED", // Assuming PaymentStatus is nested under 'paymentDetails'
    createdAt: new Date(),
  });
